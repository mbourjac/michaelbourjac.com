function pageLayout(element, number) {
    ...
    const pageOfSlide = document.createElement("div");
    const containerOfPage = document.createElement("div");
    const imageOfContainer = document.createElement("img");

    containerOfPage.appendChild(imageOfContainer);
    ...
    if (innerHeight < 500) {
        ...
        if (smallDragscroll.includes(number)) {
            ...
            containerOfPage.classList.add("dragscroll", "dragscroll--small");
...
landscapeNav(desktopNav, desktopContent, desktopAnchorId);
landscapeNav(mobileNav, mobileContent, mobileAnchorId);
...
function portraitLayout() {
    for (let i = 1; i < 284; i++) {
        ...
        if (i === 1 || blank.includes(i)) {
            div.classList.add("content--japon--portrait__container--blank");
        } else {
            img.classList.add("content--japon--portrait__image");
        }
...
portraitNavLayout(portraitNavData);
...
function moreOne() {
    captionDiv.style.cursor = "";
    captionDiv.innerHTML = 'Jōgasaki Kaigan, 25 juillet 2019 - 15:27:11<br>Jōgasaki Kaigan, 25 juillet 2019 - 15:27:13<br>Jōgasaki Kaigan, 25 juillet 2019 - 15:27:20<br>Jōgasaki Kaigan, 25 juillet 2019 - 15:27:21<br>Jōgasaki Kaigan, 25 juillet 2019 - 15:27:23';
}

function moreTwo() {
    captionDiv.style.cursor = "";
    captionDiv.innerHTML = 'Jōgasaki Kaigan, 25 juillet 2019 - 13:25:56<br>Jōgasaki Kaigan, 25 juillet 2019 - 12:15:12<br>Jōgasaki Kaigan, 25 juillet 2019 - 11:49:27<br>Jōgasaki Kaigan, 25 juillet 2019';
}
...
function moreFour() {
    captionDiv.style.cursor = "";
    captionDiv.innerHTML = 'Nankai Kōya Line, 4 août 2019 - 09:23:31<br>Nankai Kōya Line, 4 août 2019 - 09:23:37<br>Nankai Kōya Line, 4 août 2019 - 09:23:50<br>Nankai Kōya Line, 4 août 2019 - 09:24:48';
}

function moreFive() {
    captionDiv.style.cursor = "";
    captionDiv.innerHTML = 'Tokyo, Yamanote Line, 10 août 2019 - 20:54:47<br>Tokyo, Yamanote Line, 10 août 2019 - 20:54:52<br>Tokyo, Yamanote Line, 10 août 2019 - 20:54:54<br>Tokyo, Yamanote Line, 10 août 2019 - 20:54:56';
}
...
for (let i = 1; i < 196; i++) {
    document.getElementById(`next-${i}`).addEventListener("click", function () {
        if (i === 195) {
            ...
            captionDiv.innerHTML = captions[i];
            captionDiv.addEventListener("click", moreOne);
            captionDiv.style.cursor = "pointer";
        } else if (i === 47) {
            captionDiv.innerHTML = captions[i];
            captionDiv.addEventListener("click", moreTwo);
            captionDiv.style.cursor = "pointer";
        } else if (i === 54) {
            captionDiv.innerHTML = captions[i];
            captionDiv.addEventListener("click", moreThree);
            captionDiv.style.cursor = "pointer";
        } else if (i === 123) {
            captionDiv.innerHTML = captions[i];
            captionDiv.addEventListener("click", moreFour);
            captionDiv.style.cursor = "pointer";
        } else if (i === 166) {
            captionDiv.innerHTML = captions[i];
            captionDiv.addEventListener("click", moreFive);
            captionDiv.style.cursor = "pointer";
        } else {
            captionDiv.innerHTML = captions[i];
            
            captionDiv.removeEventListener("click", moreOne);
            captionDiv.removeEventListener("click", moreTwo);
            captionDiv.removeEventListener("click", moreThree);
            captionDiv.removeEventListener("click", moreFour);
            captionDiv.removeEventListener("click", moreFive);
            captionDiv.style.cursor = "";
        } 
    });
    ...
    document.getElementById(`prev-${i}`).addEventListener("click", function () {
        if (i === 1) {
            ...
            captionDiv.innerHTML = captions[i - 2];
            captionDiv.addEventListener("click", moreOne);
            captionDiv.style.cursor = "pointer";
        } else if (i === 49) {
            captionDiv.innerHTML = captions[i - 2];
